create table public.companies (
  ...
  sector_value text GENERATED ALWAYS as ((sector ->> 'value'::text)) STORED null,
  sub_sector_value text GENERATED ALWAYS as ((sub_sector ->> 'value'::text)) STORED null,
